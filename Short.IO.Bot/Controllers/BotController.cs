...
// namespace Short.IO.Bot.Controllers
// {
...
//     {
//         private readonly Dictionary<string, IBotFrameworkHttpAdapter> _adapters =
//             new Dictionary<string, IBotFrameworkHttpAdapter>();
...
//             var adapterSettings =
//                 configuration
//                     .GetSection(AdapterSettings.AdapterSettingsKey)
//                     .Get<List<AdapterSettings>>() ?? new List<AdapterSettings>();
...
//                         $"PostAsync: routed '{route}' to {adapter.GetType().Name}"
//                     );
//                 }
...
//             {
//                 _logger.LogError(
//                     $"PostAsync: No adapter registered and enabled for route {route}."
//                 );
//                 throw new KeyNotFoundException(
//                     $"No adapter registered and enabled for route {route}."
//                 );
//             }
//         }
//     }
